...
public class customerMenu {
    ...
    public static void foodBeverageMenu(FoodAndBeverage[] fnbArr){
        ...
        System.out.println("====================================");
        System.out.println("1. " + fnbArr[0].getProdName() + " - RM  7.00");
        System.out.println("2. " + fnbArr[1].getProdName() + "        - RM  5.00");
        System.out.println("3. " + fnbArr[2].getProdName() + "  - RM 10.00");
        System.out.println("4. " + fnbArr[3].getProdName() + "  - RM  6.00");
    ...
    public static void receiptA(){
        ...
        System.out.println("\t==============================================");
        System.out.println("\tChoice of F&B : " + testProg.fnbArr[0].getProdName());
    ...
    public static void receiptB(){
        ...
        System.out.println("\t\t\tF&B Receipt");
        System.out.println("\t==============================================");
        System.out.println("\tChoice of F&B : " + testProg.fnbArr[1].getProdName());
    ...
    public static void receiptC(){
        ...
        System.out.println("\t\t\tF&B Receipt");
        System.out.println("\t==============================================");
        System.out.println("\tChoice of F&B : " + testProg.fnbArr[2].getProdName());
    ...
    public static void receiptD(){
        ...
        System.out.println("\t\t\tF&B Receipt");
        System.out.println("\t==============================================");
        System.out.println("\tChoice of F&B : " + testProg.fnbArr[3].getProdName());
    ...
    public static void menuMain(FoodAndBeverage[] fnbArr){
