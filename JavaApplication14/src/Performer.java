...
public class Performer extends Person{
    ...
    public Performer(String name, String ic, char gender, String contact) {
        super(name, ic, gender, contact);
    }

    public Performer(String performerId, String managingCompany, String name, String ic, char gender, String contact) {
        super(name, ic, gender, contact);
